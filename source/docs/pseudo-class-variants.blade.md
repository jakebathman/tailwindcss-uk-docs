...
@component('_partials.code-sample', ['lang' => 'html', 'class' => 'bg-grey-200 p-8'])
<div class="group hover:bg-blue-500 p-4 cursor-pointer bg-white rounded max-w-xs w-full shadow-lg select-none overflow-hidden mx-auto">
  <p class="font-semibold text-lg mb-1 text-grey-900 group-hover:text-white">New Project</p>
  <p class="text-grey-700 group-hover:text-white mb-2">Create a new project from a variety of starting templates.</p>
</div>


@slot('code')
<div class="group bg-white hover:bg-blue-500 ...">
  <p class="text-grey-900 group-hover:text-white ...">New Project</p>
  <p class="text-grey-700 group-hover:text-white ...">Create a new project from a variety of starting templates.</p>
</div>
@endslot
@endcomponent
