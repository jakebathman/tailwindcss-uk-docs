...
<div class="bg-grey-400 mr-3 p-4 rounded-sm">.rounded-sm</div>
<div class="bg-grey-400 mr-3 p-4 rounded">.rounded</div>
<div class="bg-grey-400 p-4 rounded-lg">.rounded-lg</div>
@slot('code')
...
@component('_partials.code-sample', ['class' => 'flex items-centre justify-around text-sm'])
<div class="bg-grey-400 mr-3 py-2 px-4 rounded-full">Pill shape</div>
<div class="bg-grey-400 h-16 w-16 rounded-full flex items-centre justify-centre">Circle</div>
@slot('code')
<div class="rounded-full py-2 px-4">Pill shape</div>
<div class="rounded-full h-16 w-16 flex items-centre justify-centre">Circle</div>
@endslot
@endcomponent
...
<div class="p-4 rounded-none bg-grey-400">.rounded-none</div>
@slot('code')
...
@component('_partials.code-sample', ['class' => 'flex justify-around text-sm'])
<div class="bg-grey-400 mr-3 p-4 rounded-t-lg">.rounded-t-lg</div>
<div class="bg-grey-400 mr-3 p-4 rounded-r-lg">.rounded-r-lg</div>
<div class="bg-grey-400 mr-3 p-4 rounded-b-lg">.rounded-b-lg</div>
<div class="bg-grey-400 p-4 rounded-l-lg">.rounded-l-lg</div>
@slot('code')
...
@component('_partials.code-sample', ['class' => 'flex justify-around text-sm'])
<div class="bg-grey-400 mr-3 p-4 rounded-tl-lg">.rounded-tl-lg</div>
<div class="bg-grey-400 mr-3 p-4 rounded-tr-lg">.rounded-tr-lg</div>
<div class="bg-grey-400 mr-3 p-4 rounded-br-lg">.rounded-br-lg</div>
<div class="bg-grey-400 p-4 rounded-bl-lg">.rounded-bl-lg</div>
@slot('code')
...
<div class="flex justify-centre">
  <div class="bg-grey-500 w-12 h-12 rounded"></div>
</div>
@endslot
@slot('sm')
<div class="flex justify-centre">
  <div class="bg-grey-500 w-12 h-12 rounded-t"></div>
</div>
@endslot
@slot('md')
<div class="flex justify-centre">
  <div class="bg-grey-500 w-12 h-12 rounded-b-lg"></div>
</div>
@endslot
@slot('lg')
<div class="flex justify-centre">
  <div class="bg-grey-500 w-12 h-12 rounded-none"></div>
</div>
@endslot
@slot('xl')
<div class="flex justify-centre">
  <div class="bg-grey-500 w-12 h-12 rounded-r"></div>
</div>
@endslot
@slot('code')
...
@component('_partials.customised-config', ['key' => 'theme.borderRadius'])
  'none': '0',
- 'sm': '.125rem',
- default: '.25rem',
+ default: '4px',
